...
The goal of this deep dive is to provide experience solving problems in a recursive manner.
...
1. Create a recursive function to compute the factorial of a given integer *n*.
2. Create a recursive function to generate the Fibonacci Sequence to the *nth* term.
3. Create a recursive function that counts the number of digits in a given number *n*.
4. Create a recursive function that returns the largest value in an array of integers.
5. Create a recursive Un-ordered Permutation function as described below:
...
Note: There are many ways to generate all unordered permutations of a given set. Your output does *not* need to match this example exactly.{#task}


---

#### Requirements {#reqs}
1. Complete & be able to explain your solution to **task 1.**
2. Complete & be able to explain your solution to **task 2.**
3. Complete & be able to explain your solution to **task 3.**
4. Complete & be able to explain your solution to **task 4.**
5. Complete & be able to explain your solution to **task 5.**
